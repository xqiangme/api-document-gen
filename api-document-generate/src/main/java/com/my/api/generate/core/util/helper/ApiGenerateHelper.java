...
import com.my.api.generate.core.constants.ValidationConstant;
...
import com.my.api.generate.core.model.*;
import com.my.api.generate.core.util.tool.*;
import com.my.api.generate.core.util.tool.*;
import com.my.api.generate.start.ApiGenerateStart;
import com.my.api.generate.core.model.*;
...
public class ApiGenerateHelper {
    ...
    public static void checkRequiredConfig(Class runClazz, ApiConfig config) {
        ...
        if (ApiGenerateTypeEnum.CLAZZ.equals(config.getGenerateType()) && CollectionUtils.isEmpty(config.getApiClassNameList())) {
    ...
    public static void checkRequiredConfigByXml(ApiConfig config) {
        ...
        if (ApiGenerateTypeEnum.CLAZZ.equals(config.getGenerateType()) && CollectionUtils.isEmpty(config.getApiClassPathList())) {
    ...
    public static String generateByPackage(JavaProjectBuilder rootPathJavaFile, Class runClazz, ApiConfig config) {
        ...
        for (JavaClass clazz : generateClassList) {
            ApiOutModel apiOutModel = getApiOutModel(rootPathJavaFile, clazz, paramExcludeSet, config);
            if (null == apiOutModel) {
                continue;
            }
    ...
    public static String generateByClass(JavaProjectBuilder rootPathJavaFile, ApiConfig config) {
        ...
        List<String> apiClassList;
        if (isPathWay) {
            apiClassList = config.getApiClassPathList();
        } else {
            apiClassList = config.getApiClassNameList();
        }
