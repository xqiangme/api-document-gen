...
public class ApiStringPool {
    ...
    public static final String BACK_SLASH_POINT = "\\.";
    ...
    public static final String SLASH_LEFT_BRACKET = "\\(";
    public static final String SLASH_RIGHT_BRACKET = "\\)";
    ...
    public static final String SLASH_$_STR = "\\$";
